...
#### API References
##### Sender App API
- [Android API](https://smartviewsdk.github.io/API-GUIDE/android-api/docs/)
- [iOS API](https://smartviewsdk.github.io/API-GUIDE/ios-api/docs/)
- [JavaScript API](https://smartviewsdk.github.io/API-GUIDE/js-api/docs/overview.html)
